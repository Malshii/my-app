...
const _Error = __webpack_require__(2);
const {
  StripeAPIError,
...
const {HttpClient} = __webpack_require__(3);
// Provide extension mechanism for Stripe Resource Sub-Classes
StripeResource.extend = utils.protoExtend;
// Expose method-creator
StripeResource.method = __webpack_require__(33);
...
let exec = null;
try {
  exec = __webpack_require__(32).exec;
} catch (e) {
  // @ts-ignore
...
function getNodeCryptoProvider() {
  if (!webhooksNodeCryptoProviderInstance) {
    const NodeCryptoProvider = __webpack_require__(14);
...
const crypto = __webpack_require__(11);
const CryptoProvider = __webpack_require__(7);
/**
...
const stripe = __webpack_require__(16)('sk_test_51MHQ4TJgdBMmHGmLs95IPqWdurgSvWicz3HeZ24ZAp3WqBdXdhw4l6rv2NCEeGt9KmqHQYi95uxzn3SCQAbR1SZ900gN7qt5BO');
...
const _Error = __webpack_require__(2);
const resources = __webpack_require__(17);
const DEFAULT_HOST = 'api.stripe.com';
const DEFAULT_PORT = '443';
const DEFAULT_BASE_PATH = '/v1/';
const DEFAULT_API_VERSION = null;
const DEFAULT_TIMEOUT = 80000;
Stripe.PACKAGE_VERSION = __webpack_require__(123).version;
const utils = __webpack_require__(1);
...
const {HttpClient, HttpClientResponse} = __webpack_require__(3);
...
Stripe.createNodeHttpClient = (agent) => {
  const {NodeHttpClient} = __webpack_require__(124);
...
Stripe.createFetchHttpClient = (fetchFn) => {
  const {FetchHttpClient} = __webpack_require__(127);
...
Stripe.createSubtleCryptoProvider = (subtleCrypto) => {
  const SubtleCryptoProvider = __webpack_require__(128);
...
const resourceNamespace = __webpack_require__(18);
module.exports = {
  // Support Accounts for consistency, Account for backwards compatibility
  Account: __webpack_require__(8),
  AccountLinks: __webpack_require__(35),
  Accounts: __webpack_require__(8),
  ApplePayDomains: __webpack_require__(36),
  ApplicationFees: __webpack_require__(37),
  Balance: __webpack_require__(38),
  BalanceTransactions: __webpack_require__(39),
  Charges: __webpack_require__(40),
  CountrySpecs: __webpack_require__(41),
  Coupons: __webpack_require__(42),
  CreditNotes: __webpack_require__(43),
  Customers: __webpack_require__(44),
  Disputes: __webpack_require__(45),
  EphemeralKeys: __webpack_require__(46),
  Events: __webpack_require__(47),
  ExchangeRates: __webpack_require__(48),
  FileLinks: __webpack_require__(49),
  Files: __webpack_require__(50),
  InvoiceItems: __webpack_require__(52),
  Invoices: __webpack_require__(53),
  Mandates: __webpack_require__(54),
  OAuth: __webpack_require__(55),
  PaymentIntents: __webpack_require__(56),
  PaymentLinks: __webpack_require__(57),
  PaymentMethods: __webpack_require__(58),
  Payouts: __webpack_require__(59),
  Plans: __webpack_require__(60),
  Prices: __webpack_require__(61),
  Products: __webpack_require__(62),
  PromotionCodes: __webpack_require__(63),
  Quotes: __webpack_require__(64),
  Refunds: __webpack_require__(65),
  Reviews: __webpack_require__(66),
  SetupAttempts: __webpack_require__(67),
  SetupIntents: __webpack_require__(68),
  ShippingRates: __webpack_require__(69),
  Sources: __webpack_require__(70),
  SubscriptionItems: __webpack_require__(71),
  Subscriptions: __webpack_require__(72),
  SubscriptionSchedules: __webpack_require__(73),
  TaxCodes: __webpack_require__(74),
  TaxRates: __webpack_require__(75),
  Tokens: __webpack_require__(76),
  Topups: __webpack_require__(77),
  Transfers: __webpack_require__(78),
  WebhookEndpoints: __webpack_require__(79),
  Apps: resourceNamespace('apps', {
    Secrets: __webpack_require__(80),
  }),
  BillingPortal: resourceNamespace('billingPortal', {
    Configurations: __webpack_require__(81),
    Sessions: __webpack_require__(82),
  }),
  Checkout: resourceNamespace('checkout', {
    Sessions: __webpack_require__(83),
  }),
  FinancialConnections: resourceNamespace('financialConnections', {
    Accounts: __webpack_require__(84),
    Sessions: __webpack_require__(85),
  }),
  Identity: resourceNamespace('identity', {
    VerificationReports: __webpack_require__(86),
    VerificationSessions: __webpack_require__(87),
  }),
  Issuing: resourceNamespace('issuing', {
    Authorizations: __webpack_require__(88),
    Cardholders: __webpack_require__(89),
    Cards: __webpack_require__(90),
  ...
  Radar: resourceNamespace('radar', {
    ...
    ValueListItems: __webpack_require__(94),
    ValueLists: __webpack_require__(95),
  }),
  ...
  Terminal: resourceNamespace('terminal', {
    Configurations: __webpack_require__(99),
    ConnectionTokens: __webpack_require__(100),
    Locations: __webpack_require__(101),
    Readers: __webpack_require__(102),
  }),
  TestHelpers: resourceNamespace('testHelpers', {
    Customers: __webpack_require__(103),
    Refunds: __webpack_require__(104),
    TestClocks: __webpack_require__(105),
    Issuing: resourceNamespace('issuing', {
      Cards: __webpack_require__(106),
    }),
    Terminal: resourceNamespace('terminal', {
      Readers: __webpack_require__(107),
    }),
    Treasury: resourceNamespace('treasury', {
      InboundTransfers: __webpack_require__(108),
      OutboundPayments: __webpack_require__(109),
      OutboundTransfers: __webpack_require__(110),
      ReceivedCredits: __webpack_require__(111),
      ReceivedDebits: __webpack_require__(112),
    }),
  }),
  Treasury: resourceNamespace('treasury', {
    CreditReversals: __webpack_require__(113),
    DebitReversals: __webpack_require__(114),
    FinancialAccounts: __webpack_require__(115),
    InboundTransfers: __webpack_require__(116),
    OutboundPayments: __webpack_require__(117),
    OutboundTransfers: __webpack_require__(118),
    ReceivedCredits: __webpack_require__(119),
    ReceivedDebits: __webpack_require__(120),
    TransactionEntries: __webpack_require__(121),
    Transactions: __webpack_require__(122),
  }),
};
...
var getSideChannel = __webpack_require__(21);
...
var callBound = __webpack_require__(26);
...
var utilInspect = __webpack_require__(29);
...
const autoPagination = __webpack_require__(34);
...
const {multipartRequestDataProcessor} = __webpack_require__(51);
const StripeResource = __webpack_require__(0);
const stripeMethod = StripeResource.method;
module.exports = StripeResource.extend({
  create: stripeMethod({
...
module.exports = {"name":"stripe","version":"11.4.0","description":"Stripe API wrapper","keywords":["stripe","payment processing","credit cards","api"],"homepage":"https://github.com/stripe/stripe-node","author":"Stripe <support@stripe.com> (https://stripe.com/)","contributors":["Ask Bjørn Hansen <ask@develooper.com> (http://www.askask.com/)","Michelle Bu <michelle@stripe.com>","Alex Sexton <alex@stripe.com>","James Padolsey"],"repository":{"type":"git","url":"git://github.com/stripe/stripe-node.git"},"bugs":"https://github.com/stripe/stripe-node/issues","engines":{"node":">=12.*"},"main":"lib/stripe.js","types":"types/index.d.ts","devDependencies":{"@typescript-eslint/eslint-plugin":"^4.33.0","@typescript-eslint/parser":"^4.33.0","chai":"^4.3.6","chai-as-promised":"~7.1.1","coveralls":"^3.1.1","eslint":"^7.32.0","eslint-config-prettier":"^8.5.0","eslint-plugin-chai-friendly":"^0.7.2","eslint-plugin-prettier":"^3.4.1","mocha":"^8.4.0","mocha-junit-reporter":"^2.1.0","nock":"^13.2.9","node-fetch":"^2.6.7","nyc":"^15.1.0","prettier":"^1.16.4","typescript":"^4.8.4"},"resolutions":{"minimist":"1.2.6","nanoid":"^3.2.0"},"dependencies":{"@types/node":">=8.1.0","qs":"^6.11.0"},"license":"MIT","scripts":{"build":"tsc -p tsconfig.json && yarn remove-exports-line && yarn prettier-format","remove-exports-line":"sed -i.bak '/Object.defineProperty(exports, \"__esModule\", { value: true });/d' ./lib/stripe.js; rm ./lib/stripe.js.bak","clean":"rm -rf ./.nyc_output ./node_modules/.cache ./coverage ./lib","prepack":"yarn install && yarn build","mocha":"nyc mocha --config=test/.mocharc.js","mocha-only":"mocha --config=test/.mocharc.js","test":"yarn build && yarn test-typescript && yarn mocha","test-typescript":"tsc --build types/test","lint":"eslint --ext .js,.jsx,.ts .","fix":"yarn lint --fix && ./scripts/updateAPIVersion.js","report":"nyc -r text -r lcov report","coveralls":"cat coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js","prettier-format":"prettier --config .prettierrc 'lib/**/*.js' --write"}}
...
const http = __webpack_require__(125);
const https = __webpack_require__(126);
const _HttpClient = __webpack_require__(3);
